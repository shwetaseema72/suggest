...
$query_insert= "Insert into profile (picture, link) values ('images/ripudaman.jpg', 'ripudaman')";
...
<body>		
	      	  ...
	      	  <div class="header_top">
					  ...
					  <div class="profile_details">
				             ...
				             <div class="profile_img">	
				             	<a href="#"><img src="images/ripudaman1.jpg" alt="" />	</a>
				             </div>		
				             <div class="clear"></div>		  	
					    </div>	
		 		      <div class="clear"></div>				 
	...
	<td>987654321</td>
 	...
 	<tr>
	<td>Address</td>
	<td>#3451 B Flat , Urban Colony, Ludhiana</td>
	</tr>
	<tr>
	<td>Email&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td>damangogna@gmail.com</td>
	</tr>
	</table>
				      </div>
	    		 </div>
            ...
            <div class="column_middle">
              <div class="column_middle_grid1">
		         <div class="profile_picture">
		        	<a href=""><img src="images/ripudaman.jpg" alt="" />	</a>		         
				   ...
				   <h3>Search your friends</h3>
					     ...
					     <form  method="post"  id="searchform"> 
					    	...
					    	<span>
					 	     ...
					 	     <input type="text" value="" placeholder="Enter your search" name="search_query" id="search_query" size="50"/>
