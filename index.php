    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Suggest me</a>
            </div>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>Suggest Me</h1>
                <hr>
                <p>Start finding people nearby you and with your similar interests. Make connections professional and social.</p>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    	<div class="container-fluid">
			...
			<span class="icon-bar"></span>
				...
				<a class="navbar-brand" href="">Suggest Me</a>
			</div>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-lr animated flipInX" role="menu">
                            <div class="col-lg-12">
								...
								<form id="ajax-register-form" action="registration.php" method="post" role="form" autocomplete="off">
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 text-center">Be sure to login or register first.</div>
    </div>
</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="light">
                    <p class="text-faded">Connections that are helpful. :)</p>
